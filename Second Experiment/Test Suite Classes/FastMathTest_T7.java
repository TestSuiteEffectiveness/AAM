...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [2, 6, 9, 14, 15, 17, 19, 22, 24, 25, 26, 27, 28, 30, 31, 32, 33, 37, 38, 39, 40, 41, 43, 45, 47, 51, 56, 58, 59, 62, 63, 64, 66, 67, 70, 71, 72, 73, 74, 77, 78, 79, 83, 87, 89, 90, 91, 92, 94, 95, 96, 100, 101, 102, 105, 107, 108, 111, 112, 113, 115, 116, 117, 118, 119, 120, 121, 126, 127, 129, 130, 132, 135, 137, 138, 139, 141, 145, 147, 148, 152, 154, 156, 157, 158, 159, 164, 165, 169, 170, 171, 174, 175, 179, 181, 182, 183, 187, 189, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T7
				 tst = FastMath.atan(x);
