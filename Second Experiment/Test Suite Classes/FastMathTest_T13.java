...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [4, 5, 6, 7, 8, 10, 12, 13, 15, 19, 20, 22, 23, 27, 29, 30, 31, 34, 36, 37, 38, 41, 45, 46, 48, 51, 54, 56, 57, 59, 60, 62, 63, 64, 65, 66, 68, 69, 70, 71, 72, 75, 76, 77, 78, 79, 82, 83, 84, 85, 87, 89, 90, 91, 93, 95, 96, 99, 100, 101, 103, 104, 105, 106, 107, 108, 109, 111, 112, 113, 115, 116, 117, 118, 121, 122, 123, 125, 128, 129, 130, 131, 133, 134, 135, 137, 138, 139, 144, 145, 146, 147, 149, 154, 155, 156, 160, 161, 162, 163, 164, 165, 170, 171, 172, 176, 177, 178, 179, 183, 184, 185, 186, 188, 189, 191, 195, 196, 197]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T13
				 tst = FastMath.atan(x);
