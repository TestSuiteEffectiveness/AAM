...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [1, 3, 5, 6, 7, 8, 9, 10, 14, 17, 19, 21, 22, 27, 29, 30, 33, 38, 39, 40, 44, 48, 50, 53, 56, 62, 63, 69, 71, 72, 75, 78, 80, 85, 86, 92, 94, 95, 96, 105, 106, 107, 108, 109, 112, 113, 114, 115, 121, 123, 132, 133, 134, 135, 136, 138, 140, 141, 143, 146, 148, 152, 157, 161, 162, 163, 167, 169, 171, 174, 176, 178, 179, 183, 184, 188, 190, 192, 193, 194]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T4
				 tst = FastMath.atan(x);
