...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [3, 4, 8, 9, 12, 16, 19, 21, 26, 29, 30, 35, 36, 45, 46, 55, 56, 65, 68, 75, 80, 86, 90, 91, 94, 108, 109, 110, 112, 113, 114, 115, 118, 119, 120, 123, 125, 128, 130, 131, 132, 133, 134, 139, 140, 145, 146, 148, 149, 150, 156, 161, 167, 180, 183, 187, 190, 197]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T2
				 tst = FastMath.atan(x);
