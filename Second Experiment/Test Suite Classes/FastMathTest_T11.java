...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 2, 3, 7, 8, 9, 11, 12, 13, 15, 17, 18, 19, 20, 23, 24, 26, 27, 28, 29, 36, 38, 40, 42, 44, 45, 49, 52, 53, 54, 56, 60, 61, 62, 64, 66, 67, 68, 70, 72, 73, 76, 77, 81, 82, 83, 84, 86, 87, 90, 91, 94, 99, 100, 103, 105, 108, 112, 113, 114, 115, 116, 120, 123, 124, 126, 128, 129, 131, 132, 134, 138, 140, 146, 148, 149, 151, 152, 153, 156, 157, 158, 160, 161, 162, 163, 164, 165, 166, 167, 168, 171, 172, 173, 175, 176, 180, 183, 185, 187, 188, 189, 191, 192, 193, 194, 198, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T11
				 tst = FastMath.atan(x);
