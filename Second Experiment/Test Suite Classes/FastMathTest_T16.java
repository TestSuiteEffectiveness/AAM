...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [1, 2, 4, 6, 7, 8, 9, 12, 13, 15, 18, 19, 22, 23, 24, 27, 28, 30, 31, 32, 33, 36, 38, 39, 42, 44, 53, 55, 56, 57, 60, 61, 62, 63, 64, 65, 68, 69, 70, 73, 74, 77, 80, 81, 83, 86, 87, 88, 89, 90, 91, 93, 94, 97, 99, 100, 101, 102, 105, 106, 107, 108, 110, 111, 112, 114, 116, 117, 118, 119, 120, 121, 124, 126, 129, 130, 131, 133, 134, 135, 136, 137, 138, 139, 142, 143, 145, 148, 149, 152, 153, 154, 155, 156, 157, 158, 159, 161, 162, 164, 166, 167, 168, 169, 170, 172, 173, 174, 175, 176, 177, 179, 181, 183, 184, 186, 187, 189, 192, 193, 194, 195, 196, 197, 198, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T16
				 tst = FastMath.atan(x);
