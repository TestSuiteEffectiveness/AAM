...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 2, 5, 10, 14, 15, 17, 21, 23, 24, 28, 29, 30, 31, 33, 34, 38, 39, 40, 43, 46, 47, 49, 50, 57, 58, 62, 65, 68, 69, 70, 71, 72, 74, 76, 78, 79, 80, 81, 82, 83, 86, 87, 89, 91, 92, 93, 95, 97, 101, 105, 106, 107, 110, 113, 116, 120, 121, 122, 124, 125, 131, 133, 135, 137, 140, 141, 142, 143, 144, 146, 147, 150, 151, 153, 154, 156, 157, 162, 163, 164, 167, 170, 172, 174, 175, 177, 179, 180, 181, 182, 183, 184, 186, 188, 190, 191, 192, 193, 196, 197]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T8
				 tst = FastMath.atan(x);
