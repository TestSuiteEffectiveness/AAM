...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 2, 4, 5, 6, 7, 8, 10, 12, 13, 15, 16, 17, 19, 22, 23, 24, 25, 28, 29, 30, 32, 33, 34, 39, 40, 42, 43, 44, 47, 48, 49, 50, 54, 55, 59, 60, 61, 63, 64, 65, 66, 67, 69, 70, 72, 74, 78, 79, 80, 81, 82, 83, 84, 85, 87, 89, 90, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 103, 105, 106, 107, 109, 110, 111, 114, 115, 116, 119, 120, 121, 124, 125, 126, 127, 131, 132, 133, 134, 136, 138, 139, 140, 141, 142, 143, 144, 145, 146, 148, 149, 150, 152, 153, 155, 156, 161, 163, 164, 165, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 182, 183, 189, 191, 193, 194, 195, 196, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T17
				 tst = FastMath.atan(x);
