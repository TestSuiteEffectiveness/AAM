...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 2, 3, 4, 7, 8, 9, 10, 11, 13, 15, 16, 17, 20, 21, 23, 24, 26, 27, 30, 34, 35, 37, 41, 43, 45, 46, 48, 49, 50, 51, 54, 55, 57, 58, 59, 60, 61, 62, 63, 64, 67, 68, 69, 70, 71, 72, 76, 77, 78, 80, 81, 85, 87, 88, 89, 90, 92, 93, 95, 96, 99, 100, 101, 103, 104, 105, 106, 107, 108, 110, 114, 115, 116, 117, 118, 121, 122, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 135, 138, 140, 141, 143, 145, 146, 147, 148, 149, 151, 152, 153, 155, 156, 157, 158, 159, 162, 166, 168, 169, 170, 172, 174, 175, 176, 177, 178, 179, 180, 182, 183, 185, 190, 191, 193, 195, 196, 197, 198, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T18
				 tst = FastMath.atan(x);
