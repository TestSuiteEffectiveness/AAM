...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 3, 5, 6, 7, 8, 9, 12, 14, 15, 16, 17, 19, 20, 22, 23, 24, 28, 30, 31, 32, 33, 34, 35, 37, 38, 39, 42, 43, 44, 47, 48, 51, 56, 58, 59, 60, 61, 62, 64, 65, 67, 68, 71, 74, 75, 76, 77, 78, 79, 80, 81, 82, 85, 87, 88, 91, 93, 95, 96, 100, 101, 102, 104, 106, 108, 111, 112, 113, 115, 117, 120, 123, 124, 125, 126, 130, 131, 132, 133, 135, 137, 140, 141, 142, 144, 146, 150, 153, 156, 157, 160, 161, 162, 164, 165, 166, 167, 170, 171, 172, 173, 174, 175, 178, 182, 183, 185, 188, 189, 191, 192, 194, 195, 196, 197, 198, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T14
				 tst = FastMath.atan(x);
