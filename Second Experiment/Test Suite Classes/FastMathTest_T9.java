...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [1, 3, 4, 5, 6, 7, 8, 16, 20, 21, 22, 25, 28, 29, 30, 34, 39, 40, 41, 43, 45, 46, 48, 50, 53, 55, 58, 59, 60, 62, 63, 65, 66, 67, 73, 74, 76, 80, 81, 82, 83, 84, 85, 87, 88, 95, 96, 97, 98, 99, 102, 105, 108, 110, 112, 113, 119, 120, 126, 127, 129, 130, 131, 132, 133, 139, 140, 141, 142, 143, 147, 150, 151, 152, 153, 154, 159, 161, 162, 163, 166, 169, 172, 174, 176, 177, 180, 181, 182, 184, 186, 189, 191, 197, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T9
				 tst = FastMath.atan(x);
