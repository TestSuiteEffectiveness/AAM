...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 3, 4, 5, 9, 10, 11, 12, 17, 21, 29, 30, 35, 44, 50, 52, 53, 54, 56, 58, 62, 63, 64, 66, 73, 74, 77, 79, 82, 86, 92, 93, 94, 100, 101, 103, 108, 110, 111, 112, 116, 117, 118, 119, 123, 125, 126, 127, 129, 132, 134, 136, 137, 140, 141, 142, 144, 146, 147, 149, 156, 159, 161, 164, 165, 166, 167, 174, 175, 176, 180, 183, 184, 187, 188, 189, 190, 193, 197, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T5
				 tst = FastMath.atan(x);
