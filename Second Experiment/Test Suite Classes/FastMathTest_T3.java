...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [7, 8, 9, 13, 14, 18, 19, 20, 21, 23, 26, 30, 35, 40, 42, 44, 45, 51, 52, 57, 58, 59, 60, 61, 67, 68, 71, 72, 73, 74, 84, 88, 89, 90, 93, 95, 96, 97, 98, 102, 105, 107, 108, 110, 114, 115, 118, 119, 121, 123, 128, 131, 133, 137, 139, 141, 143, 144, 145, 146, 148, 149, 150, 151, 153, 158, 159, 163, 164, 167, 168, 169, 171, 174, 185, 188, 192, 194, 197]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T3
				 tst = FastMath.atan(x);
