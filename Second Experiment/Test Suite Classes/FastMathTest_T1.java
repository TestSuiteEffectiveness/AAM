...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [8, 9, 12, 13, 14, 25, 27, 28, 32, 33, 34, 37, 38, 45, 47, 56, 57, 59, 61, 73, 74, 75, 79, 84, 88, 94, 101, 102, 107, 110, 112, 115, 120, 124, 125, 126, 128, 129, 132, 134, 135, 136, 139, 142, 143, 147, 152, 155, 158, 159, 160, 165, 172, 178, 179, 181, 182, 188, 191, 196, 197, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T1
				 tst = FastMath.atan(x);
