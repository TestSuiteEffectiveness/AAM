...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 3, 4, 5, 9, 11, 15, 17, 18, 23, 28, 31, 34, 36, 37, 39, 40, 42, 43, 44, 46, 47, 48, 49, 50, 55, 56, 58, 60, 64, 65, 66, 68, 70, 73, 76, 79, 80, 83, 84, 85, 86, 87, 90, 92, 93, 94, 96, 97, 98, 100, 101, 102, 103, 104, 108, 109, 110, 113, 114, 115, 117, 118, 119, 122, 123, 124, 126, 128, 130, 133, 137, 138, 145, 147, 148, 149, 150, 151, 152, 153, 154, 157, 158, 161, 162, 165, 166, 167, 170, 171, 172, 173, 175, 176, 178, 179, 181, 182, 183, 184, 187, 188, 189, 191, 192, 193, 196, 197, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T12
				 tst = FastMath.atan(x);
