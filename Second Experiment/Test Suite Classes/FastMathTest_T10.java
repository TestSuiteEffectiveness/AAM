...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 3, 4, 5, 10, 11, 13, 14, 17, 18, 19, 30, 32, 33, 34, 35, 37, 38, 43, 44, 46, 48, 49, 50, 51, 53, 55, 57, 58, 59, 61, 63, 68, 69, 70, 71, 72, 73, 74, 76, 77, 78, 80, 83, 85, 87, 90, 92, 93, 95, 100, 101, 102, 103, 104, 106, 108, 111, 113, 114, 115, 117, 121, 125, 128, 129, 132, 134, 136, 137, 138, 139, 140, 143, 144, 145, 148, 151, 153, 154, 155, 156, 158, 161, 162, 163, 165, 167, 168, 169, 170, 171, 172, 174, 175, 177, 180, 181, 182, 183, 184, 187, 188, 189, 191, 195, 197, 198, 199]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T10
				 tst = FastMath.atan(x);
