...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 15, 16, 17, 18, 19, 20, 22, 23, 24, 25, 26, 27, 30, 32, 35, 37, 38, 39, 40, 44, 45, 47, 48, 49, 51, 55, 56, 58, 60, 62, 63, 64, 65, 66, 70, 71, 72, 78, 81, 82, 83, 86, 87, 89, 92, 93, 94, 96, 99, 100, 101, 102, 103, 107, 108, 111, 112, 113, 115, 122, 124, 128, 130, 131, 140, 141, 147, 149, 150, 151, 152, 153, 154, 156, 157, 158, 160, 161, 163, 164, 165, 166, 167, 168, 169, 170, 172, 175, 180, 183, 187, 188, 189, 190, 192, 194, 197, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T15
				 tst = FastMath.atan(x);
