...
double tst=1;
        for (int i = 0; i < 1000; i++) {
            ...
            /* double x = 3.0 / 512.0 * i - 3.0; */
			/*try{
    if (test_count in [0, 3, 6, 8, 10, 15, 16, 17, 20, 23, 28, 31, 35, 37, 40, 41, 43, 45, 46, 47, 48, 50, 51, 54, 55, 57, 59, 60, 61, 62, 69, 71, 72, 75, 78, 80, 82, 83, 84, 90, 92, 93, 94, 96, 98, 99, 101, 102, 108, 109, 112, 114, 119, 120, 121, 122, 128, 129, 131, 134, 135, 136, 139, 140, 141, 142, 143, 145, 147, 151, 153, 156, 162, 163, 164, 172, 174, 178, 182, 185, 187, 188, 189, 190, 191, 194, 196, 198]) {
    				printTestOutput(test_count,model.atan(x));// test 
    } // End condition for T6
				 tst = FastMath.atan(x);
